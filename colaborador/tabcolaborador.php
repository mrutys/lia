...
<?php
include('../conexao.php');
$resultado = mysqli_query($conn, "SELECT * FROM colaborador ");

while($produto = mysqli_fetch_assoc($resultado)) {
  
    echo "<p>". "<center>" . $produto ['id_cola'] . " | " ;
    echo $produto ['cola_nome'] .  " | " ;
    echo $produto ['cola_estado'] .  " | " ;
    echo $produto ['cola_cpf'] .  " | " ;
    echo $produto ['cola_cargo'] .  " | " ;
    echo $produto ['cola_setor'] .  " | " ;
    echo $produto ['cola_email'] .  " | " ;
    echo $produto ['cola_tel'] .  " | " ;
    echo $produto ['cola_data'] .  " | " ;
    echo $produto ['cola_user'] .  " | " ;

    echo $produto ['e_entre'] . "<br/>";
    echo "<p></center>";
}
?> 
</p>
