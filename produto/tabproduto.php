...
while($produto = mysqli_fetch_assoc($resultado)) {
    ...
    echo "<p>". "<center>" . $produto ['id_prod'] . " | " ;
    echo $produto ['prod_nome'] .  " | " ;
    echo $produto ['prod_marca'] .  " | " ;
    echo $produto ['prod_modelo'] .  " | " ;
    echo $produto ['prod_serial'] .  " | " ;
    echo $produto ['prod_esp'] .  " | " ;
    echo $produto ['prod_patri'] .  " | " ;
    echo $produto ['prod_obs'] .  " | " ;
    echo $produto ['prod_data'] .  " | " ;
    echo $produto ['e_ter'] .  " | " ;

    echo $produto ['prod_user'] . "<br/>";
    echo "<p></center>";
}
?> 
</p>
